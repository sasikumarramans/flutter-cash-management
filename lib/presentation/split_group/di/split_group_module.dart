...
class SplitGroupModule extends InjectableModule {
  ...
  Future<void> inject() async {
    ...
    safeRegisterSingleton<GetSplitsUseCase>(() => GetSplitsUseCase());
    safeRegisterSingleton<SearchUseCase>(() => SearchUseCase());
  }
  ...
  void dispose() {
    ...
    safeUnregister<GetSplitsUseCase>();
    safeUnregister<SplitRepository>();
    safeUnregister<SearchUseCase>();
  }
}
